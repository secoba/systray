...
@interface AppSysTrayDelegate: NSObject <NSApplicationDelegate>
...
@implementation AppSysTrayDelegate {
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
  ...
  //[self->menu setDelegate:(AppSysTrayDelegate *)self];
...
void registerSystray(void) {
  ...
  owner = [[AppSysTrayDelegate alloc] init];
